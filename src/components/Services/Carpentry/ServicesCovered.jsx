...
const servicesOffered = [
  {
    ...
    description:
      "Handcrafted furniture pieces tailored to your specific needs and style",
  },
  {
    icon: <Hammer size={24} />,
    title: "Home Repairs",
    description:
      "Expert repairs for wooden structures, floors, doors, and windows",
  },
  {
    icon: <Hammer size={24} />,
    title: "Cabinet Making",
    description: "Custom cabinet design, building, and installation services",
  },
  {
    icon: <TreePine size={24} />,
    title: "Wood Restoration",
    description:
      "Professional restoration of antique furniture and wooden structures",
  },
  {
    icon: <Ruler size={24} />,
    title: "Custom Installations",
    description: "Professional installation of wooden fixtures and built-ins",
  },
  {
    icon: <Clock size={24} />,
  ...
  },
  {
    ...
    description: "Full-scale painting and finishing services",
  },
  {
  ...
  return (
    <Section>
      <Container>
        ...
        >
          <h2>
            <Hammer size={32} /> Carpentry Services
          </h2>
        </SectionHeader>
