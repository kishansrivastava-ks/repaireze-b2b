...
const servicesOffered = [
  {
    ...
    description:
      "Complete pest elimination and prevention for homes and apartments",
  },
  {
    icon: <Rat size={24} />,
    title: "Rodent Control",
    description:
      "Effective removal and prevention of rats, mice, and other rodents",
  },
  {
    icon: <Rat size={24} />,
    title: "Insect Treatment",
    description:
      "Targeted solutions for ants, roaches, bed bugs, and other insects",
  },
  {
    icon: <Shield size={24} />,
    title: "Preventive Services",
    description: "Regular treatments to maintain a pest-free environment",
  },
  {
    icon: <Microscope size={24} />,
    title: "Inspection Services",
    description: "Thorough property inspection and pest activity monitoring",
  },
  {
    icon: <Skull size={24} />,
...
const servicesNotOffered = [
  {
    ...
    description:
      "Large-scale industrial or manufacturing facility pest control",
  },
  {
    icon: <Warehouse size={24} />,
    title: "Agricultural Services",
    description: "Farm and agricultural pest management solutions",
  },
  {
    icon: <Trees size={24} />,
    title: "Garden Services",
    description: "Plant disease control and garden pest management",
  },
  {
    icon: <HardHat size={24} />,
    title: "Construction Sites",
    description: "Pest control for active construction environments",
  },
];
  ...
  return (
    <Section>
      <Container>
        ...
        >
          <h2>
            <Bug size={32} /> Pest Control Services
          </h2>
        </SectionHeader>
